...
ARG stamp=main-20210409T134703Z-gf8a7780
ARG version=1.0
...
ARG pkgs='bash-completion-2.1-8.el7 bind-utils-9.11.4-26.P2.el7_9.4 libcgroup-tools-0.41-21.el7 cronie-1.4.11-23.el7 e2fsprogs-libs-1.42.9-19.el7  gettext-0.19.8.1-3.el7 git-1.8.3.1-23.el7_8.x86_64 iperf3-3.1.7-2.el7.x86_64 iproute-4.11.0-30.el7 jq-1.6-2.el7 net-tools-2.0-0.25.20131004git.el7 nmon-16g-3.el7 openssh-server-7.4p1-21.el7 python2-pip-8.1.2-14.el7 python3-3.6.8-18.el7 rsyslog-8.24.0-57.el7_9 smartmontools-7.0-2.el7 strace-4.24-6.el7 sudo-1.8.23-10.el7_9.1 wget-1.14-18.el7_6.1 http://10.33.140.165/gage-packages/kernel/4.14.4-1/kernel-ml-4.14.4-1.el7.elrepo.x86_64.rpm http://10.33.140.165/gage-packages/kernel/5.7.10-1/kernel-ml-5.7.10-1.el7.elrepo.x86_64.rpm ansible-2.9.18-1.el7 docker-ce-20.10.3-3.el7 pigz-2.3.4-1.el7 python-docker-py-1.10.6-11.el7 python-netaddr-0.7.5-9.el7 python2-pip-8.1.2-14.el7 unzip-6.0-21.el7 '
